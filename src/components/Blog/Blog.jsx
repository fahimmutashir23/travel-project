                ...
                <div className="mx-auto space-y-6 sm:space-y-12">
                    ...
                    <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
                        <a rel="noopener noreferrer" href="#" className=" mx-auto group hover:no-underline focus:no-underline dark:bg-gray-900">
                            <img role="presentation" className="object-cover w-full rounded-xl h-64 dark:bg-gray-500 p-2 shadow-lg" src="https://theworldtravelguy.com/wp-content/uploads/2021/02/DSCF0068-3_450sb.jpg" />
                        ...
                        <a rel="noopener noreferrer" href="#" className=" mx-auto group hover:no-underline focus:no-underline dark:bg-gray-900">
                            <img role="presentation" className="object-cover w-full rounded-xl h-64 dark:bg-gray-500 p-2 shadow-lg" src="https://i.postimg.cc/CMJtwbL1/pexels-elie-nammour-13313660.jpg" />
                        ...
                        <a rel="noopener noreferrer" href="#" className="mx-auto group hover:no-underline focus:no-underline dark:bg-gray-900">
                            <img role="presentation" className="object-cover w-full rounded-xl h-64 dark:bg-gray-500 p-2 shadow-lg" src="https://i.postimg.cc/W3y2yCKR/pexels-tayssir-kadamany-16571234.jpg" />
                            <div className="p-6 space-y-2">
                        ...
                        <a rel="noopener noreferrer" href="#" className="mx-auto group hover:no-underline focus:no-underline dark:bg-gray-900 hidden sm:block">
                            <img role="presentation" className="object-cover w-full rounded-xl h-64 dark:bg-gray-500 p-2 shadow-lg " src="https://i.postimg.cc/sDvny8N6/pexels-brett-sayles-1084362.jpg" />
                            <div className="p-6 space-y-2">
