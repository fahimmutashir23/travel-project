        ...
        <div className="navbar bg-base-100 max-w-6xl mx-auto">
          <div className="navbar-start">
            <div className="dropdown">
              ...
              <ul tabIndex={0} className="dropdown-content lg:mt-3 z-[100] lg:p-2 shadow rounded-box w-36">
                {navLinks}
              </ul>
            </div>
            <div>
          ...
          <div className="navbar-end">
            ...
            <label tabIndex={0} className="btn btn-ghost btn-circle avatar"><div className="w-10 rounded-full"><img src="https://i.ibb.co/LpR33BN/male-avatar-profile-picture-vector-10210618.jpg" alt="" /></div></label>
