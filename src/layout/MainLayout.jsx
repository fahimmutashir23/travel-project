      ...
      <div className="flex gap-2 relative mt-24 px-4">
        <div
          className={`rounded-lg relative ${
            open
              ? "w-[50px] bg-base-300 min-h-screen transition-all duration-1000"
              : "w-60 transition-all duration-1000"
          }`}
        >
          <div className={`fixed ${open? "": 'bg-base-300 w-60' } min-h-screen px-4 py-2 rounded-md transition-all duration-1000`}>
