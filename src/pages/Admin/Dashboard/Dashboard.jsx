    ...
    <div>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="border flex justify-between items-center h-20 rounded-lg">
          <div className="h-full text-center bg-violet-700 w-1/2 p-6">
        ...
        <div className="border flex justify-between items-center h-20 rounded-lg">
          <div className="h-full text-center bg-green-500 w-1/2 p-6">
        ...
        <div className="border flex justify-between items-center h-20 rounded-lg">
          <div className="h-full text-center bg-blue-700 w-1/2 p-6">
        ...
        <div className="border flex justify-between items-center h-20 rounded-lg">
          <div className="h-full text-center bg-pink-700 w-1/2 p-6">
