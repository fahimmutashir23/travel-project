...
const useMessage = (info, reserveDays) => {
    ...
    Thank you for choosing to stay with us. We are pleased to confirm the reservation for ${info.userName}. ${info.roomPrice * reserveDays}$The details of the booking confirmation are attached along with this Invoice.
