              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div className="grid content-center gap-4">
                  <div className="p-6 rounded shadow-md dark:bg-gray-900">
                    <img
                      src="https://gotravel.qodeinteractive.com/wp-content/uploads/2016/11/single-gallery-5-image-2.jpg"
                      alt=""
                  ...
                  <div className="p-6 rounded shadow-md dark:bg-gray-900">
                    <img
                      src="https://themes-themegoods.b-cdn.net/grandtour/demo/wp-content/uploads/2016/12/pexels-photo-115070.jpeg"
                      alt=""
                ...
                <div className="grid content-center gap-4">
                  <div className="p-6 rounded shadow-md dark:bg-gray-900">
                    <img
                      src="http://themes.themegoods.com/grandtour/demo2/wp-content/uploads/2016/12/pexels-photo-210243.jpeg"
                      alt=""
