...
const TourPackagesPage = () => {
    ...
    const sliders = [{img: "https://www.cssigniter.com/demos/milos/wp-content/uploads/sites/17/2021/04/Fotolia_52127130_Subscription_Monthly_XXL.jpg", title: "THE WORLD IS YOURS", des: "EXPLORE OUR ECO AND ADVENTURE TRAVEL ITINERARIES"}, {img: "https://travelicious.bold-themes.com/main-demo/wp-content/uploads/sites/2/2018/09/destination-berlin-07.jpg", title: "THE WORLD IS YOURS", des: "EXPLORE OUR ECO AND ADVENTURE TRAVEL ITINERARIES."}, {img: "https://i.postimg.cc/LsLTn5BX/sultanahmet-mosque-blue-mosque-istanbul-by-day-159938-3260.webp", title: "THE WORLD IS YOURS", des: "EXPLORE OUR ECO AND ADVENTURE TRAVEL ITINERARIES."}, {img: "https://themes-themegoods.b-cdn.net/grandtour/demo2/wp-content/uploads/2016/12/Parks-Mountains-Pagodas-Sakura-Volcano-Branches-Aizuwakamatsu-Castle-Tsuruga-Castle-Fukushima-Mount-Fuji-Cities-Japan-Wallpaper-Widescreen-HD-1680x1050-700x466.jpg", title: "THE WORLD IS YOURS", des: "EXPLORE OUR ECO AND ADVENTURE TRAVEL ITINERARIES."}, {img: "https://themetechmount.com/wordpress/a3trip/demo4/wp-content/uploads/sites/11/2023/12/d3-min.jpg", title: "THE WORLD IS YOURS", des: "EXPLORE OUR ECO AND ADVENTURE TRAVEL ITINERARIES."},];
    ...
    return (
        <div>
<div className="w-full h-72 sm:h-96 md:h-[540px] lg:h-[500px] xl:h-[780px] flex flex-col xl:flex-row items-center justify-center gap-5 lg:gap-10 relative bg-cover before:absolute before:bg-black/50 before:inset-0 transform duration-1000 ease-linear z-50 overflow-hidden"
