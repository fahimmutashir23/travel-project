                    ...
                    <div className="flex mx-auto border-dotted border-slate-800">
                      ...
                      <div className="flex justify-between flex-1 px-4 mt-5 mb-5">
                        <div className="flex flex-col justify-between">
                          <div>
                            <h1 className="text-lg font-semibold text-blue-950">{room.room_name}</h1>
                          </div>
                          <div className="flex gap-4">
                            <button className="rounded-none h-9 text-base py-1 min-h-fit "><FaUser /></button>
                            <div className="flex items-center text-sm"><IoBed className="w-6 h-6 mr-1"/>{room.beds}  </div>
                          </div>
                        </div>
                        <div className="flex flex-col justify-between">
                          <div className="flex justify-end">
                            <Rating sx={{ fontSize: '22px', color:"yellow" }} name="read-only" readOnly />
                          </div>
                          <div>
